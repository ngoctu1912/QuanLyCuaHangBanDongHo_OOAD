    ...
    public boolean Validation() {
        if (Validation.isEmpty(tenNcc.getText())) {
            ...
            return false;
                ...
                || sodienthoai.getText().length() > 12 || sodienthoai.getText().length() < 1) {
            JOptionPane.showMessageDialog(this, "Số điện thoại không được rỗng, phải là số và có độ dài từ 1-12 ký tự", "Cảnh báo !", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        return true;
    }
