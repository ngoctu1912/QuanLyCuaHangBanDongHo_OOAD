...
public final class TaoPhieuNhap extends JPanel implements ItemListener, ActionListener {
    ...
    InputForm txtMaphieu, txtNhanVien, txtMaSp, txtTenSp, txtDongia, txtSoLuongSPnhap ;
    SelectForm cbxNhaCungCap; //, cbxDanhMuc
    JTextField txtTimKiem;
    JLabel  lbltongtien;

    Main m;
    PhieuNhap jpPhieuNhap;
    ...
    public TaoPhieuNhap(PhieuNhap jpPhieuNhap, NhanVienDTO nv, String type, Main m ){
        this.jpPhieuNhap = jpPhieuNhap;
        this.nvDto = nv;
        this.m = m;
    ...
    public void mousePressed(MouseEvent e) {
        ...
        txtMaSp.setPreferredSize(new Dimension(100, 90));
        ...
        content_right_top.add(txtMaSp, BorderLayout.CENTER);
        ...
        if (chitietphieu.isEmpty()) {
            ...
            if (input == 0) {
                ...
                if (result) {
                    ...
                    jpPhieuNhap.refreshData();
                    m.setPanel(jpPhieuNhap);
                } else {
