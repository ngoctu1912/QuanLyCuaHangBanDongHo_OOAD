...
public class ThongKeTongQuan extends JPanel {
    ...
    String[][] getSt = {
        ...
        {"Nhân viên đang hoạt động", "staff1.svg", Integer.toString(NhanVienDAO.getInstance().selectAll().size())}};
    ...
    private void initComponent() {
        ...
        chart.addLegend("Vốn", new Color(45, 55, 72), new Color(74, 85, 104));
        chart.addLegend("Doanh thu", new Color(26, 32, 44), new Color(45, 55, 72));
        chart.addLegend("Lợi nhuận", new Color(113, 128, 150), new Color(160, 174, 192));
