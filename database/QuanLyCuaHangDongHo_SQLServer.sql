...
CREATE TABLE [DANHMUCCHUCNANG] (
    [MCHUCNANG] NVARCHAR(50) NOT NULL,
    [TEN] NVARCHAR(255) NOT NULL,
    [TT] INT NOT NULL DEFAULT 1,
...
CREATE TABLE [CTQUYEN] (
    ...
    PRIMARY KEY([MNQ], [MCHUCNANG], [HANHDONG])
);

CREATE TABLE [NHOMQUYEN] (
    [MNQ] INT IDENTITY(1,1) NOT NULL,
    [TEN] NVARCHAR(255) NOT NULL,
    [TT] INT NOT NULL DEFAULT 1,
    PRIMARY KEY([MNQ])
);
...
CREATE TABLE [TAIKHOAN] (
    ...
    [TDN] NVARCHAR(255) NOT NULL UNIQUE,
    [MNQ] INT NOT NULL,
...
CREATE TABLE [NHACUNGCAP] (
    [MNCC] INT IDENTITY(1,1) NOT NULL,
    [TEN] NVARCHAR(255) NOT NULL,
    [DIACHI] NVARCHAR(255),
    [SDT] VARCHAR(12),
    [EMAIL] VARCHAR(50),
...
CREATE TABLE [CTPHIEUNHAP] (
    ...
    [HINHTHUC] INT NOT NULL DEFAULT 0,
    PRIMARY KEY([MPN], [MSP])
);

CREATE TABLE [PHIEUKIEMKE] (
    [MPKK] INT IDENTITY(1,1) NOT NULL,
    [MNV] INT NOT NULL,
    [TG] DATETIME DEFAULT GETDATE(),
    [TT] INT NOT NULL DEFAULT 1,
    PRIMARY KEY([MPKK])
...
CREATE TABLE [PHIEUSUACHUA] (
    [MSC] INT IDENTITY(1,1) NOT NULL,
    -- [MPB] INT NOT NULL,  -- Xóa bảo hành
    [MNV] INT,
...
INSERT INTO [NHANVIEN] ([HOTEN], [GIOITINH], [NGAYSINH], [SDT], [EMAIL], [MCV], [MCN], [TT])
VALUES
        ('Võ Thị Thu Luyện', 0, '2005-05-01', '0963841257', 'luyn0505.@gmail.com', 1, 'sanpham', 1),
        ('Nguyễn Thị Ngọc Tú', 0, '2005-01-28', '0396532145', 'ngoctu@gmail.com', 2, 'phieuxuat', 1),
        ('Trần Thị Xuân Thanh', 0, '2005-01-22', '0387913347', 'xuanthanh.@gmail.com', 2, 'phieuxuat', 1),
        ('Đỗ Hữu Lộc', 1, '2003-04-11', '0355374322', 'musicanime2501@gmail.com', 2, 'phieuxuat', 1),
        ('Đỗ Nam Anh', 1, '2003-04-11', '0123456789', 'chinchin@gmail.com', 2, 'phieuxuat', 1),
        ('Đinh Ngọc Ánh', 1, '2003-04-03', '0123456789', 'ngocan@gmail.com', 2, 'phieuxuat', 1);
...
VALUES
        ('Mặc định', '', '', 1, '2025-04-15', 0),
        ('Nguyễn Văn Anh', '45 An Dương Vương, Phường Chợ Quán, Thành phố Hồ Chí Minh', '0387913347', 1, '2025-04-15', 300),
        ('Trần Nhất Nhất', '270 Hưng Phú, phường Chánh Hưng, Thành phố Hồ Chí Minh', '0123456789', 1, '2025-04-15', 300),
        ('Hoàng Gia Bảo', '45 Trương Đình Hội, phường Phú Định, Thành phố Hồ Chí Minh', '0987654321', 1, '2025-04-15', 0),
        ('Hồ Minh Hưng', '5 Võ Thị Sáu, phường Xuân Hòa, Thành phố Hồ Chí Minh', '0867987456', 1, '2025-04-15', 0),
        ('Nguyễn Thị Minh Anh', '50 Phạm Văn Chí, phường Bình Tiên, Thành phố Hồ Chí Minh', '0935123456', 1, '2025-04-16', 0),
        ('Trần Đức Minh', '789 Lê Hồng Phong, Thành Phố Đà Nẵng', '0983456789', 1, '2025-04-16', 0),
        ('Lê Hải Yến', '180 Hoàng Ngân, Xã Trung Hòa, Hà Nội', '0977234567', 1, '2025-04-16', 0),
        ('Phạm Thanh Hằng', '325 Nguyễn Văn Tăng, Phường Long Bình, Thành phố Hồ Chí Minh', '0965876543', 1, '2025-04-16', 0),
        ('Hoàng Đức Anh', '321 Lý Thường Kiệt, Thành phố Cần Thơ', '0946789012', 1, '2025-04-16', 0),
        ('Ngô Thanh Tùng', '393 Điện Biên Phủ, Phường Bàn Cờ, Thành phố Hồ Chí Minh', '0912345678', 1, '2025-04-16', 0),
        ('Võ Thị Kim Ngân', '123 Đường Lê Lợi, Phường Hồng Bàng 2, Thành phố Hải Phòng', '0916789123', 1, '2025-04-16', 0),
        ('Đỗ Văn Tú', '777 Hùng Vương, Thành phố Huế', '0982345678', 1, '2025-04-30', 0),
        ('Lý Thanh Trúc', '81 Hoàng Cầm, Phường Linh Xuân, Thành phố Hồ Chí Minh', '0982123456', 1, '2025-04-16', 0),
        ('Bùi Văn Hoàng', '222 Đường 2/4, Thành phố Nha Trang', '0933789012', 1, '2025-04-16', 0),
        ('Lê Văn Thành', '23 Đường 3 Tháng 2, phường Hòa Hưng, TP. Hồ Chí Minh', '0933456789', 1, '2025-04-16', 0),
        ('Nguyễn Thị Lan Anh', '45 Hàng Bạc, phường Hoàn Kiếm, TP. Hà Nội', '0965123456', 1, '2025-04-16', 0),
        ('Phạm Thị Mai', '234 Nguyễn Trãi, phường Chợ Quán, TP. Hồ Chí Minh', '0946789013', 1, '2025-04-17', 0),
        ('Hoàng Văn Nam', ' 567 Phố Huế, phường Hai Bà Trưng, Hà Nội', '0912345679', 1, '2025-04-17', 0);
